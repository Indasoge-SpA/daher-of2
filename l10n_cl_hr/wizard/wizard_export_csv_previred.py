...
class WizardExportCsvPrevired(models.TransientModel):
    ...
    #caso se paga en la mutual respectiva. Datos no numérico
                                 ...
                                 int(self.get_imponible_ccaf(payslip and payslip[0] or False, self.get_payslip_lines_value_2(payslip,'TOTIM'))) if (self.get_dias_trabajados(payslip and payslip[0] or False)>0 and payslip.indicadores_id.ccaf_id and payslip.indicadores_id.ccaf_id.code != '00') else "0",
